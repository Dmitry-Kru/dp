...
SECRET_KEY = 'django-insecure-zd@lp$qg#+3(62jzk7(ii4kyf=#k1bfy5$pv-**_tiqq&*3r%l'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'environment': 'dj_proj.jinja2_env.environment',
            'extensions': [
...
CSRF_USE_SESSIONS = False  # Должно быть False для работы с cookie
